...
from azure.ai.generative.synthetic.simulator._model_tools import LLMBase, ManagedIdentityAPITokenManager
...
from azure.ai.generative.synthetic.simulator.templates.simulator_templates import SimulatorTemplates, Template
